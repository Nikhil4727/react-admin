...
// import FullCalender,{formateDate} from "@fullcalendar/react";
...
//         if(window.confirm(`Are yu sure you want to delete the event '${selected.event.title}'`
//         )
//       ) {
...
// return (
//     <Box m="20px">
//         <Header title="CALENDER" subtitle="Full Calnder Interactive Page"/>
